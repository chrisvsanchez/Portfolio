    ...
    <Wrapper>
      ...
      <AboutTextWrapper>
        ...
        <p>
          ...
          bootcamps in NYC, Flatiron School, through the Tech Talent Pipeline. I
          was thrilled! During my time in FI I crossed the line from tutorial
          hell to building full stack applications. My experience collaborating
          with other developers and challenging one another to surpass our
          imaginations with what we could build has shaped me. Since then, I
          have worked with other teams on Chingu and developers around the
          world, and am always working on a side project to continue learning.
        </p>
        <p>
